...
public class PersistenceService {
    ...
    private static final String PREF_SELECTED_NATIONS = "selected_nations";
    ...
    Set<String> getSelectedNationsPref() {
        ...
        Set<String> nations = sharedPreferences.getStringSet(PREF_SELECTED_NATIONS, Sets.newHashSet());
        nations = Sets.newHashSet(nations);
        return nations;
    }

    @NonNull
    Set<String> getAllNationsPref() {
    ...
    void setNations(Collection<String> nations) {

        sharedPreferences.edit().putStringSet(PREF_NATIONS, Sets.newHashSet(nations)).apply();

    }

    private void updateNations(Set<String> nations) {

        sharedPreferences.edit().putStringSet(PREF_SELECTED_NATIONS, nations).apply();
    }
    ...
    void removeAllSelectedNations() {
        ...
        sharedPreferences.edit().remove(PREF_SELECTED_NATIONS).apply();
